...
Route::group(['middleware' => ['jwtauth', 'verified', 'role:admin']], function () {
    ...
    /* likes on articles */
    Route::get('likes-article', [ArticleController::class, 'likesOnArtilces']);

});

Route::get('count-comments', [CommentController::class, 'countComment']);
Route::get('count-likes', [UsersController::class, 'countLike']);
Route::get('count-users', [UsersController::class, 'countUser']);
Route::get('count-articles', [ArticleController::class, 'countArticles']);
